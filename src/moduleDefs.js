...
const CATEGORIES = [
  { key: "oscillator", label: "Oscillators", modules: ["OscA", "OscB", "OscC", "Noise", "DrumSynth", "FormantOsc"] },
  { key: "filter", label: "Filters", modules: ["Filter", "FilterC", "FilterE"] },
  { key: "modulator", label: "Modulators", modules: ["Envelope", "ADSREnv", "LFO", "LFOA", "ClkGen", "RandomGen", "PortamentoA"] },
